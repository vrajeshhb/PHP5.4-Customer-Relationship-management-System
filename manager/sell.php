...
<div class="page-container row-fluid">	
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
		...
		<h1><u>YOUR SELLS BY EMPLOYEE :</u></h1>
		<table width="950" style="margin-top:40px;" class="altrowstable" id="alternatecolor">
			...
			<tr style="background-image:url(../images/work_7.jpg); font-size:20px;"> 
					...
					<td width="275">EMPYOLEE </td>
					<td width="100">Products </td>
					<td width="100">SOLD</td>
					<td width="170">COMPLETED ON</td>
			...
			<?php 
			$role = "employee";
$sql = "SELECT * FROM  `employee` where org_id = '".$_SESSION['org']."' and role = '".$role."' ORDER BY  `emp_id` DESC ";
//echo $sql;
$q=mysql_query($sql);
$no=0;
