    ...
    <div class="content">  
		...
		<table width="950" style="margin-top:40px;" class="altrowstable" id="alternatecolor">
			...
			<tr style="background-image:url(../images/work_7.jpg); font-size:20px;"> 
					...
					<td width="275">SERVICE / PRODUCT </td>
					<td width="100">CATAGOEY </td>
					<td width="100">TYPE</td>
					<td width="170">UPLOADED ON</td>
					<td width="150">DEADLINE </td>
					<td width="100">COMPLETED </td>
						
			</tr>
			<?php 
$sql = "SELECT * FROM  `jobs` where created_by = '".$_SESSION['id']."' ORDER BY  `jobs`.`job_id` DESC ";
//echo $sql;
$q=mysql_query($sql);
$no=0;
