...
<div class="page-container row-fluid">	
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
		...
		<form action="contact.php" method="post" name="frm" >
		<table >
			<tr>
					<td>
					<select name="id">
					<?php
					$s_q = mysql_query("select * from client where Assigned_By =  '".$_SESSION['id']."' ");
					while($res_q = mysql_fetch_array($s_q))
					{
					?>
						<option value="<?php echo $res_q[0]; ?>"><?php echo $res_q[4]; ?> </option>
					<?php
					}
					?>
					</select>
					</td>
					<td style="padding-left:20px;"><input style="background-color:#0099FF; color:#FFFFFF; width:150px; height:35px;"  type="submit" name="submit" value="VIEW"/> </td>
			</tr>
		</table>
		</form>
		<br /><br />
...
{
	$sql = "select * from client where client_id = '".$_POST['id']."' ";
}
$q=mysql_query($sql);
$no=0;
