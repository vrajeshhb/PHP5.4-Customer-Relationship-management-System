		...
		<div class="page-title">	
            ...
            <div class="row">
                        <div class="col-md-12">
                            <?php
								if(isset($_POST['change']))
								{
									...
									if(strcmp($new,$con) == 0)
									{
										...
										$query = "UPDATE  `crm`.`employee` SET  `password` =  '$new' WHERE  `employee`.`email` = '$email' ;";
							...
							?>
                            <form class="form-horizontal" name="form1" method="post" action="change-password.php" onSubmit="return valid();">
